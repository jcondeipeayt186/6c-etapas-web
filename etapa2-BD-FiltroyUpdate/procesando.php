...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // El formulario de index.php en modo edicion envia accion="actualizar" + id oculto
    if (isset($_POST['accion']) && $_POST['accion'] === 'actualizar') {
        $id = (int) $_POST['id'];

        // Verificamos que llegaron los campos obligatorios
        if (isset($_POST['nombre']) && isset($_POST['apellido']) && isset($_POST['dni'])) {
            ...
            // Llamamos a la funcion que ejecuta el UPDATE en la base de datos
    ...
    if (isset($_POST['nombre']) && isset($_POST['apellido']) && isset($_POST['dni'])) {
        // CASO 3: INSERTAR una nueva persona   
